...
void EPwm1Setup()
{
	InitEPwm1Gpio();
		    ...
		    EPwm1Regs.TBPHS.half.TBPHS=0;                 //ʱ����λ�Ĵ�������Ϊ0
		    EPwm1Regs.TBCTR=0;                            //ʱ������������
		    EPwm1Regs.TBCTL.bit.CTRMODE=TB_COUNT_UPDOWN;  //����ģʽ
		    EPwm1Regs.TBCTL.bit.PRDLD=TB_SHADOW;
		    EPwm1Regs.TBCTL.bit.PHSEN=TB_DISABLE;         //��ֹ��λ����
		    EPwm1Regs.TBCTL.bit.SYNCOSEL=TB_CTR_ZERO;     //CTR=ZERO���ͬ���ź�
		    EPwm1Regs.TBCTL.bit.HSPCLKDIV=TB_DIV1;         //TBCLK=SYSCLKOUT
		    EPwm1Regs.TBCTL.bit.CLKDIV=TB_DIV1;

		    EPwm1Regs.CMPCTL.bit.SHDWAMODE=CC_SHADOW;      //CPU��Ӱ�ӼĴ���д��ֵ
		    EPwm1Regs.CMPCTL.bit.SHDWBMODE=CC_SHADOW;
		    EPwm1Regs.CMPCTL.bit.LOADAMODE=CC_CTR_ZERO;    //CTR=ZEROʱװ��
		...
		//����
			...
			EPwm1Regs.DBRED=50;//������ʱ
			EPwm1Regs.DBFED=50;//�½���ʱ
		...
		//��������
			...
			//EPwm1Regs.ETSEL.bit.INTEN = 1;//�ж�ʹ��
...
void EPwm2Setup()
{
	InitEPwm2Gpio();
		    ...
		    EPwm2Regs.TBPHS.half.TBPHS=0;                 //ʱ����λ�Ĵ�������Ϊ0
		    EPwm2Regs.TBCTR=0;                            //ʱ������������
		    EPwm2Regs.TBCTL.bit.CTRMODE=TB_COUNT_UPDOWN;  //����ģʽ
		    EPwm2Regs.TBCTL.bit.PRDLD=TB_SHADOW;
		    EPwm2Regs.TBCTL.bit.PHSEN=TB_DISABLE;         //��ֹ��λ����
		    EPwm2Regs.TBCTL.bit.SYNCOSEL=TB_CTR_ZERO;     //CTR=ZERO���ͬ���ź�
		    EPwm2Regs.TBCTL.bit.HSPCLKDIV=TB_DIV1;         //TBCLK=SYSCLKOUT
		    EPwm2Regs.TBCTL.bit.CLKDIV=TB_DIV1;

		    EPwm2Regs.CMPCTL.bit.SHDWAMODE=CC_SHADOW;      //CPU��Ӱ�ӼĴ���д��ֵ
		    EPwm2Regs.CMPCTL.bit.SHDWBMODE=CC_SHADOW;
		    EPwm2Regs.CMPCTL.bit.LOADAMODE=CC_CTR_ZERO;    //CTR=ZEROʱװ��
		...
		//����
			...
			//EPwm1Regs.DBCTL.all=0xb;
			EPwm2Regs.DBRED=50;//������ʱ
			EPwm2Regs.DBFED=50;//�½���ʱ
		...
		//��������
			...
			//EPwm2Regs.ETSEL.bit.INTEN = 1;//�ж�ʹ��
