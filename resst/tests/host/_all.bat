...
echo.
echo ===== 8/16 test_step3_telemetry =====
...
echo.
echo ===== 10/16 test_measurement_offset =====
...
echo.
echo ===== 13/16 test_run_supervisor =====
...
echo.
echo ===== 15/16 test_closedloop =====
cl.exe /nologo /W3 /wd4100 /utf-8 /Fo:"%HOST_BUILD_DIR%\\" /Fe:"%HOST_BUILD_DIR%\test_closedloop.exe" tests\host\test_closedloop.c firmware\control\control_closedloop.c /I. > nul 2>&1
if errorlevel 1 (echo BUILD FAILED & exit /b 1)
"%HOST_BUILD_DIR%\test_closedloop.exe"
if errorlevel 1 exit /b 1

echo.
echo ===== 16/16 test_justfloat =====
