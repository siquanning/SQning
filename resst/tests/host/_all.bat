...
echo.
echo ===== 8/18 test_step3_telemetry =====
...
echo.
echo ===== 10/18 test_measurement_offset =====
...
echo.
echo ===== 13/18 test_run_supervisor =====
...
echo.
echo ===== 16/18 test_pll_host_protocol =====
...
echo.
echo ===== 18/18 test_ac_protect =====
cl.exe /nologo /W3 /wd4100 /utf-8 /Fo:"%HOST_BUILD_DIR%\\" /Fe:"%HOST_BUILD_DIR%\test_ac_protect.exe" tests\host\test_ac_protect.c firmware\app\ac_protect.c /I. > nul 2>&1
if errorlevel 1 (echo BUILD FAILED & exit /b 1)
"%HOST_BUILD_DIR%\test_ac_protect.exe"
if errorlevel 1 exit /b 1
