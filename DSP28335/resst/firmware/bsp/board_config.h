...
#define BOARD_SYSCLK_MHZ         150U
#define BOARD_LSPCLK_HZ          37500000U
#define BOARD_SCI_BAUD            9600UL
#define BOARD_SCI_BRR              487U  /* 37500000/(9600*8)-1 */
 ...
 * 每个模块使用 CMPA 控制，A/B 互补输出，死区由 CPLD 处理
 */
...
/* CPLD 处理死区，DSP 输出原始桥臂参考 */
#define BOARD_PWM_DB_RED            0U
#define BOARD_PWM_DB_FED            0U

/* TBPRD = TBCLK / (2 × f_pwm),  TBCLK = SYSCLK = 150MHz */
