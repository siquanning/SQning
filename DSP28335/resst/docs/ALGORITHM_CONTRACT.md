# ALGORITHM_CONTRACT — F28335_RTControl_Platform
...
The current F28335_RTControl_Platform (formerly DROOP_SPI_UART_REFACTOR) is a UART→SPI bridge. It does not implement
